...
Аннотация для указания нужно ли передавать информацию о пользователе из данного метода\класса. Данная аннотация работает только при использовании преднастроенных  <<clients,клиентов>> или при интеграции <<interceptors,интерцепторов>> в свой клиент.
