...
public class JsonToPrincipalMapper extends JsonToPrincipalAbstractMapper<UserInfo> {

    public UserInfo map(String principal) {
        UserInfo userInfo = new Gson().fromJson(principal, new TypeToken<UserInfo>() {
        }.getType());
