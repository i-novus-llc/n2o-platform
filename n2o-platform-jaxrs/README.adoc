...
В модуль который планируете запускать, добавьте зависимости (в следующих версиях возможно вынесут в стартер n2o-platform-starter-jaxrs-server):
[source,xml]
----
<dependency>
